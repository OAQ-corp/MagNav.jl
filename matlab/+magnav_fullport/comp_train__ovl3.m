...
% Original Julia signature: function comp_train(comp_params::CompParams, lines, df_line::DataFrame, df_flight::DataFrame, df_map::DataFrame; temp_params::TempParams = TempParams(),
% Executable draft: unsupported Julia-specific lines are commented with TODO.
function out = comp_train__ovl3(comp_params, lines, df_line, df_flight, df_map, varargin)
    out = [];
