...
% TODO(Julia->MATLAB): map_drp && (itp_alt = map_itp(alt,map_xx,map_yy,:linear))
...
% TODO(Julia->MATLAB): % use interior 2 lons/lats as xx/yy limits for new (LLA) map (stay in range)
