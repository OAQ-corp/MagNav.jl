...
% Original Julia signature: function get_XYZ21(xyz_h5::String; info::String  = splitpath(xyz_h5)[end],
% Executable draft: unsupported Julia-specific lines are commented with TODO.
function out = get_XYZ21(xyz_h5, varargin)
    out = [];
...
% TODO(Julia->MATLAB): fields = :fields21

% TODO(Julia->MATLAB): silent || @info("reading in XYZ21 data: $xyz_h5")
